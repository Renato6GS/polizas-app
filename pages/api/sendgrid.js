...
async function sendEmail(req, res) {
  try {
    ...
    await sendgrid.send({
      ...
      from: 'renatogranadosgt@gmail.com', // your website email address here
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
              ...
              <h3>Has recibido un correo de ${req.body.fullname}, con el correo: ✉️${req.body.email} </h3>
              ...
              <p class="footer" style="font-size: 16px;padding-bottom: 20px;border-bottom: 1px solid #D1D5DB;">Atentamente<br>Control de pólizas<br>El mejor administrador de pólizas<br>+502 3881-1298</p>
